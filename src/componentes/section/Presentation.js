...
function Presentation() {
    return (
        <div className={styles.presentation} id='Presentation'>
            ...
            <p>
                Sou formado em Sistemas de Informação e venho acompanhando a tecnologia<br />
                ao longo dos anos com dedicação em áreas de suporte e infraestrutura. Atualmente<br />
                me dedico aos estudos para a migração de área com o objetivo de adentrar nesse<br /> 
